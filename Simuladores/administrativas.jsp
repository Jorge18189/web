...
<body>
    ...
    <div class="container">
        <h1>Simulacro de Examen IPN - Ciencias Sociales y Administrativas</h1>
        <p class="welcome-text">
            Prepárate para tu examen de ingreso al IPN con nuestro simulacro de Ciencias Sociales y Administrativas. Aquí te explicamos cómo completar el simulacro de manera óptima.
        </p>
        <div class="instructions">
            <h2>Instrucciones</h2>
            <ul>
                <li>Lee cada pregunta cuidadosamente antes de seleccionar tu respuesta.</li>
                <li>El simulacro consta de varias secciones, incluyendo Historia, Economía, y Habilidad Verbal.</li>
        ...
        <div class="button-container">
            <button onclick="startCountdown('simulacro4.html')">Iniciar Simulacro 1</button>
            <button onclick="startCountdown('simulacro5.html')">Iniciar Simulacro 2</button>
            <button onclick="startCountdown('simulacro6.html')">Iniciar Simulacro 3</button>
        </div>
    </div>
